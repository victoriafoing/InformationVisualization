function sample_post(data) {
    ...
    var html_stats = "<p style=\"text-align:center;padding-top:10px;\"><b>Date:</b> "+data.date+"&nbsp&nbsp&nbsp&nbsp<b>Source:</b> "+data.source+"&nbsp&nbsp&nbsp&nbsp<b>Target:</b> "+data.target+"</p>"
